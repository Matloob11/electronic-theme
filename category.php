...
<main id="main" class="inner-main">
    <section class="breadcrumb-band">
        <div class="site-container">
            ...
            <span><?php esc_html_e('Category', 'e-repair'); ?></span>
                ...
                <div class="blog-main-content">
                    <header class="archive-header">
                        <h1 class="archive-title">
                            <?php printf(esc_html__('Category: %s', 'e-repair'), single_cat_title('', false)); ?>
                        </h1>
                        <?php echo category_description() ? '<div class="archive-description">' . category_description() . '</div>' : ''; ?>
                    </header>
                    ...
                    <?php else : ?>
                        <div class="no-posts-found">
                            ...
                            <p><?php esc_html_e('It seems there is no content available for this category.', 'e-repair'); ?></p>
                            <?php get_search_form(); ?>
                        </div>
                    <?php endif; ?>
                </div>
