...
<main id="main" class="inner-main">
    <section class="breadcrumb-band">
        <div class="site-container">
            ...
            <span><?php esc_html_e('Tag', 'e-repair'); ?></span>
                ...
                <div class="blog-main-content">
                    <header class="archive-header">
                        <h1 class="archive-title">
                            <?php printf(esc_html__('Tag: %s', 'e-repair'), single_tag_title('', false)); ?>
                        </h1>
                        <?php echo tag_description() ? '<div class="archive-description">' . tag_description() . '</div>' : ''; ?>
                    </header>
                    ...
                    <?php else : ?>
                        <div class="no-posts-found">
                            ...
                            <p><?php esc_html_e('It seems there is no content available for this tag.', 'e-repair'); ?></p>
                            <?php get_search_form(); ?>
                        </div>
                    <?php endif; ?>
                </div>
