...
<main id="main" class="inner-main">
    <section class="breadcrumb-band">
        <div class="site-container">
            ...
            <span><?php esc_html_e('Blog', 'e-repair'); ?></span>
        </div>
    </section>
            ...
            <div class="blog-layout">
                <div class="blog-main-content">
                    <header class="archive-header">
                        <h1 class="archive-title"><?php esc_html_e('Blog', 'e-repair'); ?></h1>
                    </header>
                    ...
                    ?>
                        <div class="no-posts-found">
                            ...
                            <p><?php esc_html_e('It seems there is no content available for the blog right now.', 'e-repair'); ?></p>
                            <?php get_search_form(); ?>
                        </div>
                    <?php endif; ?>
                </div>
