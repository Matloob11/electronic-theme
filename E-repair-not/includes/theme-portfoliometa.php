...
$meta_box_portfolio = array(
	...
	'title' =>  __('Portfolio Options', 'e_repair'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
			'name' =>  __('Format', 'e_repair'),
			'desc' => __('Choose post format that most fit your needs. ', 'e_repair'),
    	...
    	array(
    	   'name' => __('Date', 'e_repair'),
    	   'desc' => __('Input project end date. ', 'e_repair'),
    	   'id' => $prefix . 'portfolio_date',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Client', 'e_repair'),
    	   'desc' => __('Input project owner name. ', 'e_repair'),
    	   ...
    	   'desc' => __('Additional info for this portfolio item.', 'e_repair'),
    	   'id' => $prefix . 'portfolio_info',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('URL', 'e_repair'),
    	   'desc' => __('Input the project URL (external link)', 'e_repair'),
...
$meta_box_portfolio_video = array(
	...
	'title' => __('Video Settings', 'e_repair'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Embedded Code', 'e_repair'),
			'desc' => __('Use this field to embed video from various websites (YouTube, Vimeo etc).', 'e_repair'),
...
$meta_box_portfolio_audio = array(
	...
	'title' =>  __('Audio Settings', 'e_repair'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( 
		    "name" => __('MP3 File URL','e_repair'),
				"desc" => __('The URL to the .mp3 audio file','e_repair'),
				"id" => $prefix."audio_mp3",
				"type" => "text",
				'std' => ''
		)
...
function tz_show_box_portfolio() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please choose desired Portfolio Format and fill additional fields. ', 'e_repair').'</p>';
