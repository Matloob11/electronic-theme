...
$meta_box_quote = array(
	...
	'title' =>  __('Quote Settings', 'e_repair'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The Quote','e_repair'),
				"desc" => __('Put your quote in this field.','e_repair'),
				"id" => $prefix."quote",
				"type" => "textarea"
			),
	),
...
$meta_box_link = array(
	'id' => 'tz-meta-box-link',
	'title' =>  __('Link Settings', 'e_repair'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The URL','e_repair'),
				"desc" => __('Insert the URL you wish to link to.','e_repair'),
				"id" => $prefix."link_url",
				"type" => "text"
			),
	),
...
$meta_box_image = array(
	...
	'title' =>  __('Image Settings', 'e_repair'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Enable Lightbox','e_repair'),
				"desc" => __('Check this to enable the lightbox.','e_repair'),
...
$meta_box_audio = array(
	...
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('MP3 File URL','e_repair'),
...
$meta_box_video = array(
	...
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Embeded Code','e_repair'),
				"desc" => __('You can include embeded code here.','e_repair'),
