...
function e_repair_random($length){
				...
				<script type="text/javascript">
					...
					<div class="g_pagination">
						...
						<div class="g_controls">
							<a href="#"><span id="prev-gal"><?php _e('&larr;', 'e_repair'); ?></span></a> 
							<a href="#"><span id="next-gal"><?php _e('&rarr;', 'e_repair'); ?></span></a>
						</div><!--END Prev&Next -->
