...
class MY_Vcard_Widget extends WP_Widget {
  function MY_Vcard_Widget() {
    $widget_ops = array('classname' => 'widget_e_repair_vcard', 'description' => __('Use this widget to add a vCard', 'e_repair'));
    $this->WP_Widget('widget_e_repair_vcard', __('My - vCard', 'e_repair'), $widget_ops);
    $this->alt_option_name = 'widget_e_repair_vcard';
  ...
  function widget($args, $instance) {
    $cache = wp_cache_get('widget_e_repair_vcard', 'widget');
    ...
    $title = apply_filters('widget_title', empty($instance['title']) ? __('vCard', 'e_repair') : $instance['title'], $instance, $this->id_base);
  ...
  <?php
    ...
    wp_cache_set('widget_e_repair_vcard', $cache, 'widget');
  }
  ...
  function update($new_instance, $old_instance) {
    ...
    if (isset($alloptions['widget_e_repair_vcard'])) {
      delete_option('widget_e_repair_vcard');
    }
  ...
  function flush_widget_cache() {
    wp_cache_delete('widget_e_repair_vcard', 'widget');
  }
  ...
  ?>
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title (optional):', 'e_repair'); ?></label>
      <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
    </p>
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('street_address')); ?>"><?php _e('Street Address:', 'e_repair'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('locality')); ?>"><?php _e('City/Locality:', 'e_repair'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('region')); ?>"><?php _e('State/Region:', 'e_repair'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('postal_code')); ?>"><?php _e('Zipcode/Postal Code:', 'e_repair'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('tel')); ?>"><?php _e('Telephone:', 'e_repair'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php _e('Email:', 'e_repair'); ?></label>
...
function e_repair_widget_init() {
  register_widget('MY_Vcard_Widget');
}

add_action('widgets_init', 'e_repair_widget_init');