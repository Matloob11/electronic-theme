...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$networks['Grooveshark']['link'] = $instance['grooveshark'];
		...
		$networks['Grooveshark']['label'] = $instance['grooveshark_label'];
		...
		?>
			...
			<ul class="social-networks">
					...
					<?php foreach(array("Facebook", "Twitter", "Flickr", "Feed", "Linkedin", "Delicious", "Youtube", "Google", "Pinterest", "Blogger", "Tumblr", "Vimeo", "Grooveshark") as $network) : ?>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['grooveshark_label'] = $new_instance['grooveshark_label'];
	...
	function form( $instance ) {
		...
		$grooveshark_label = $instance['grooveshark_label'];
...
?>
    	...
    	<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
			<legend style="padding:0 5px;"><?php _e('Grooveshark'); ?>:</legend>
	    	<p><label for="<?php echo $this->get_field_id('grooveshark'); ?>"><?php _e('Grooveshark URL:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('grooveshark'); ?>" name="<?php echo $this->get_field_name('grooveshark'); ?>" type="text" value="<?php echo esc_attr($grooveshark); ?>" /></p>
	        <p><label for="<?php echo $this->get_field_id('grooveshark_label'); ?>"><?php _e('Grooveshark label:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('grooveshark_label'); ?>" name="<?php echo $this->get_field_name('grooveshark_label'); ?>" type="text" value="<?php echo esc_attr($grooveshark_label); ?>" /></p>
        </fieldset>	
...
add_action('widgets_init', function() {
    return register_widget('My_SocialNetworksWidget');
});
