...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'e_repair'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Name', 'e_repair'),
    	   'desc' => __('Input author\'s name. ', 'e_repair'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input author\'s URL.', 'e_repair'),
    	   'id' => $prefix . 'testi_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	   ...
    	   'desc' => __('Input author\'s additional info.', 'e_repair'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'e_repair').'</p>';
