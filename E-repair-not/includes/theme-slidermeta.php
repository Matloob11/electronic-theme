...
$meta_box_slider = array(
	...
	'title' =>  __('Slider Options', 'e_repair'),
	'page' => 'slider',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Caption', 'e_repair'),
    	   'desc' => __('Input your caption for slide (HTML tags are allowed). ', 'e_repair'),
...
function my_add_box_slider() {
	...
	add_meta_box($meta_box_slider['id'], 
	$meta_box_slider['title'], 'my_show_box_slider', 
	$meta_box_slider['page'], 
	$meta_box_slider['context'], 
	$meta_box_slider['priority']);
...
function my_show_box_slider() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for slide. ', 'e_repair').'</p>';
