...
<main id="main" class="inner-main">
    <section class="breadcrumb-band">
        <div class="site-container">
            ...
            <span><?php esc_html_e('Search Results', 'e-repair'); ?></span>
        </div>
    </section>
                ...
                <div class="blog-main-content">
                    <header class="archive-header">
                        <h1 class="archive-title">
                            <?php printf(esc_html__('Search Results for: %s', 'e-repair'), '<span>' . get_search_query() . '</span>'); ?>
                        </h1>
                    </header>
                    ...
                    <?php else : ?>
                        <div class="no-posts-found">
                            <h2><?php esc_html_e('No results found', 'e-repair'); ?></h2>
                            <p><?php esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'e-repair'); ?></p>
                            <?php get_search_form(); ?>
                        </div>
                    <?php endif; ?>
                </div>
